...
--credits for this hero https://www.youtube.com/watch?v=cE3RiizvGsg
...
function onStepHit()
   ...
   if curStep >= 912 and curStep <= 1164 then --912
	 spin = true
   end
  if curStep >= 945 and curStep <= 1164 then --945
	 arrowMoveY=10
   end
  if curStep >= 1164 then --912
	 spin = false
   end
end
